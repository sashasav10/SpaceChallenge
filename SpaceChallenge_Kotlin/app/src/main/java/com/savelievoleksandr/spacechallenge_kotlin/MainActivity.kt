...
class MainActivity : AppCompatActivity() {
    ...
    fun startSimulation(view: View?) {
        ...
        val totalBudgetU1Phase1 =
            simulation.runSimulation(simulation.loadU1(simulation.loadItems("Phase-1.txt")))
        val totalBudgetU1Phase2 =
            simulation.runSimulation(simulation1.loadU1(simulation1.loadItems("Phase-2.txt")))
        ...
        val totalBudgetU2Phase1 =
            simulation.runSimulation(simulation.loadU2(simulation.loadItems("Phase-1.txt")))
        val totalBudgetU2Phase2 =
            simulation.runSimulation(simulation.loadU2(simulation.loadItems("Phase-2.txt")))
